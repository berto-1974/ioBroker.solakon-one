...
### Methode 1: Via GitHub URL (empfohlen)
...
Um den Adapter über GitHub zu installieren:

1. Neues GitHub-Repository mit dem Namen `ioBroker.solakon-one` erstellen
2. Den Inhalt des `ioBroker`-Ordners in das **Root-Verzeichnis** des Repositories kopieren
3. Repository pushen

```
ioBroker.solakon-one/        ← GitHub Repository Root
├── package.json
├── io-package.json
├── main.js
├── lib/
